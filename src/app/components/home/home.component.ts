...
@Component({
  ...
  template: `
    <section id="home"
      ...
      <div class="container mx-auto px-8 relative z-10 flex flex-col items-center">
        ...
        <div class="relative mb-16 group">
          ...
          <div class="relative p-2 backdrop-blur-2xl bg-white/5 border border-white/20 rounded-[3.5rem] shadow-2xl transition-transform duration-700 group-hover:scale-105 group-hover:-rotate-2">
            <div class="w-44 h-44 md:w-64 md:h-64 rounded-[3rem] overflow-hidden">
              <img src="assets/profile.jpg" alt="Omaima Assif"
            ...
            <div class="absolute -right-2 top-10 flex items-center gap-2 bg-black/60 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-full shadow-xl">
              ...
              <span class="text-[10px] font-bold uppercase tracking-tighter">Available for Hire</span>
            </div>
          </div>
        </div>

        <div class="text-center relative mb-12">
          <h1 class="text-7xl md:text-[12rem] font-black tracking-tighter leading-none relative group">
            <span class="block transition-all duration-700 group-hover:tracking-normal group-hover:opacity-20">OMAIMA</span>
            <span class="block -mt-4 md:-mt-10 bg-gradient-to-r from-purple-400 via-pink-500 to-orange-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-700">ASSIF</span>

            <span class="absolute inset-0 flex items-center justify-center text-4xl md:text-6xl font-thin opacity-0 group-hover:opacity-100 transition-all duration-700 tracking-[1em] pointer-events-none">
              ENGINEER
            </span>
          </h1>
        </div>
